...
@Deprecated
final class SlowSynonymWithPayloadsFilter extends TokenFilter {
  ...
  public SlowSynonymWithPayloadsFilter(TokenStream in, SlowSynonymMap map) {
    super(in);
    if (map == null)
  ...
  public boolean incrementToken() throws IOException {
    while (true) {
      ...
      PayloadAttribute payloadAtt = firstTok.addAttribute(PayloadAttribute.class);
      ...
      for (int i=0; i<result.synonyms.length; i++) {
        ...
        PayloadAttribute newPayloadAtt = newTok.addAttribute(PayloadAttribute.class);

        OffsetAttribute lastOffsetAtt = lastTok.addAttribute(OffsetAttribute.class);

        newOffsetAtt.setOffset(newOffsetAtt.startOffset(), lastOffsetAtt.endOffset());
        newTermAtt.copyBuffer(repTok.buffer(), 0, repTok.length());
        newPayloadAtt.setPayload(payload);
