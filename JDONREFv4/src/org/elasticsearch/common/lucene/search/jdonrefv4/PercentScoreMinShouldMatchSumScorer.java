 ...
 * @author moquetju
 */
public class PercentScoreMinShouldMatchSumScorer extends Scorer implements ICountable {
   ...
   */
  public PercentScoreMinShouldMatchSumScorer(Weight weight, List<Scorer> subScorers, int minimumNrMatchers) throws IOException {
    super(weight);
