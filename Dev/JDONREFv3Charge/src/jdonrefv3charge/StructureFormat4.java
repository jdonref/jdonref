...
/**
 * Représente une structure d'adresse sous la forme de 7 lignes.<br>
 ...
 */
public class StructureFormat4 extends Structure
{
    /**
    ...
    public Adresse altereStructure(Adresse a)
    {
        ...
        if (choix<sum2)
        {
            Adresse b = a.melangeLignes(7);
            b.structure = 3;
            return b;
        }
        Adresse b = a.melangeElements(7);
        b.structure = 3;
        return b;
    }
