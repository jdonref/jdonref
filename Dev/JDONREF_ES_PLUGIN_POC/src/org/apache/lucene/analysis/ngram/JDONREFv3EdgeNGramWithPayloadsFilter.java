 ...
 * @author Julien
 */
public class JDONREFv3EdgeNGramWithPayloadsFilter extends TokenFilter
{
   ...
   */
  @Deprecated
  public JDONREFv3EdgeNGramWithPayloadsFilter(Version version, TokenStream input, Side side, int minGram, int maxGram, boolean withPayloads) {
    super(input);
   ...
   */
  @Deprecated
  public JDONREFv3EdgeNGramWithPayloadsFilter(Version version, TokenStream input, String sideLabel, int minGram, int maxGram, boolean withPayloads) {
   ...
   * @param withPayloads true to keep payloads
   */
  public JDONREFv3EdgeNGramWithPayloadsFilter(Version version, TokenStream input, int minGram, int maxGram, boolean withPayloads) {
