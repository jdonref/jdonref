 ...
 * @lucene.experimental
 */
public final class JDONREFv3TermContext {
   ...
   */
  public JDONREFv3TermContext(IndexReaderContext context) {
    ...
    this.context = new TermContext(context);
  }
   ...
   */
  public JDONREFv3TermContext(IndexReaderContext context, TermState state, int ord, int docFreq, long totalTermFreq) {
    this(context);
   ...
   */
  public static JDONREFv3TermContext build(IndexReaderContext context, Term term)
      throws IOException {
    assert context != null && context.isTopLevel;
    final String field = term.field();
    final BytesRef bytes = term.bytes();
    final JDONREFv3TermContext perReaderTermState = new JDONREFv3TermContext(context);
  ...
  public void setDocFreq(int docFreq) {
    this.docFreq = docFreq;
    this.context.setDocFreq(docFreq);
  }
}