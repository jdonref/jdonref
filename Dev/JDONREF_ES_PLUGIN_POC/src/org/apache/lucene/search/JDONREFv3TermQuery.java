 ...
 */
public class JDONREFv3TermQuery extends Query {
    ...
    public final class TermWeight extends Weight {
        ...
        public String toString() {
            return "weight(" + JDONREFv3TermQuery.this + ")";
        }

        @Override
        public Query getQuery() {
            return JDONREFv3TermQuery.this;
        }
        ...
        public Scorer scorer(AtomicReaderContext context, boolean scoreDocsInOrder,
            ...
            return new JDONREFv3TermScorer(this, docs, similarity.simScorer(stats, context), this.index, this.searcher, maxSizePerType);
        }
    ...
    public JDONREFv3TermQuery(Term t) {
        this(t, -1);
    }
    ...
    public JDONREFv3TermQuery(Term t, int docFreq) {
        term = t;
     ...
     *  provided docFreq instead of looking up the docFreq
     *  against the searcher. */
    public JDONREFv3TermQuery(Term t, JDONREFv3TermContext states) {
        assert states != null;
        term = t;
    ...
    public Weight createWeight(IndexSearcher searcher) throws IOException {
        ...
        final JDONREFv3TermContext termState;
        if (perReaderTermState == null || perReaderTermState.topReaderContext != context) {
            // make TermQuery single-pass if we don't have a PRTS or if the context differs!
            termState = JDONREFv3TermContext.build(context, term);
        } else {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof JDONREFv3TermQuery)) {
            return false;
        }
        JDONREFv3TermQuery other = (JDONREFv3TermQuery) o;
