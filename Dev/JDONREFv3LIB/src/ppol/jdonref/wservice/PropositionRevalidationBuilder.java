 ...
 * @author marcanhe
 */
public final class PropositionRevalidationBuilder {

    private final PropositionRevalidation proposition = new PropositionRevalidation();
    ...
    public PropositionRevalidationBuilder() {
        for (int i = 0; i < 6; i++) {
            donnees.add("");
            donneesOrigine.add("");
            ids.add("");
    ...
    public PropositionRevalidation build() {
