 ...
 * @author marcanhe
 */
public final class PropositionValidationBuilder {

    private final PropositionValidation proposition = new PropositionValidation();
    ...
    public PropositionValidationBuilder() {
        for (int i = 0; i < 6; i++) {
            donnees.add("");
            donneesOrigine.add("");
            ids.add("");
    ...
    public PropositionValidation build() {
        proposition.setCode(code);
