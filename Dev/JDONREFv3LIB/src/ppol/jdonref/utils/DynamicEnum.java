...
public class DynamicEnum {
   ...
   private enum EnumTest{A,B,C}

   public static void main(String[] args) {

       // Dynamically add 3 new enum instances d, e, f to TestEnum
       addEnum(EnumTest.class, "D");
       addEnum(EnumTest.class, "E");
       addEnum(EnumTest.class, "F");

       // Run a few tests just to show it works OK.
       System.out.println(Arrays.deepToString(EnumTest.values()));
       // Shows : [a, b, c, d, e, f]
   }
}
