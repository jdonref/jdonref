 ...
 */
public class AdminLogger extends Logger {
  /**
     The root logger names itself as "root". However, the root
     logger cannot be retrieved by name.
  */
  public AdminLogger(Level level) {
    super("root");
    setLevel(level);
  }
  ...
  public AdminLogger(String name)
  {
      super(name);
  }
...
/**
  ...
  {
    AdminLoggingEvent e = new AdminLoggingEvent(fqcn, this, level, message, t);
    e.setProcessus(processus);
