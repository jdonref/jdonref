...
public class TronconDAO
{
    ...
    public ResultSet getAllTronconsByDep(Connection connection,String dpt) throws SQLException
    {
         String sql = "SELECT " +      
                ...
                "tro_typ_adr, " +                       // 12
                "tro_troncons_"+dpt+"_0.t0 AS tr_t0, " +         // 13
                "tro_troncons_"+dpt+"_0.t1 AS tr_t1, " +         // 14
                "st_AsGeoJSON(st_transform(geometrie,4326)) AS tr_geometrie "+ // 15
    ...
    public ResultSet getAllTronconsByDepBySide(Connection connection,String dpt, String side) throws SQLException
    {
//         String sql = "SELECT " +      
//                 
//                "tro_id, " +                            // 1
...
//                        "and voi_id_gauche = voi_id";  
         ...
         String sql = "SELECT " +
                ...
                "tro_id, " +                            // 28
                "voi_id_"+side+", " +                      // 29
                "tro_numero_debut_"+side+", " +            // 30
                "tro_numero_fin_"+side+", " +              // 31   
                "tro_rep_debut_"+side+", " +               // 32             
                "tro_rep_fin_"+side+", " +                 // 33
                "tro_typ_adr, " +                       // 34
                "tro_troncons_"+dpt+"_0.t0 AS tr_t0, " +         // 35
                "tro_troncons_"+dpt+"_0.t1 AS tr_t1, " +         // 36
//                "st_astext(st_transform(tro_troncons_"+dpt+"_0.geometrie,4326)) " +    // 37
                "st_AsGeoJSON(st_transform(tro_troncons_"+dpt+"_0.geometrie,4326)) AS tr_geometrie, " +    // 37
                "st_AsGeoJSON(ST_Centroid(st_transform(tro_troncons_"+dpt+"_0.geometrie,4326))) AS tr_centroide " + //38
                "FROM voi_voies_"+dpt+", com_communes, tro_troncons_"+dpt+"_0 "+
                "WHERE voi_voies_"+dpt+".com_code_insee = com_communes.com_code_insee " +
                        "and voi_id_"+side+" = voi_id";        
