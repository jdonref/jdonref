...
public class SynonymWithPayloadsTokenFilterFactory extends AbstractTokenFilterFactory {
    ...
    @Inject
    public SynonymWithPayloadsTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, Environment env, IndicesAnalysisService indicesAnalysisService, Map<String, TokenizerFactoryFactory> tokenizerFactories,
...
// fst is null means no synonyms
        return synonymMap.fst == null ? tokenStream : new SynonymWithPayloadsFilter(tokenStream, synonymMap, ignoreCase);
    }
}