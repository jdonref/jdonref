 ...
 * @author Julien
 */
public class PayloadCheckerSpanQuery_OnePayloadVersusTypeTests extends QueryTests
{
    public PayloadCheckerSpanQuery_OnePayloadVersusTypeTests()
    {
    ...
    public void testSearch() throws IOException, InterruptedException, ExecutionException
    {
        ...
        searchExactAdresse("aa cc dd","AA BB CC","DD EE",1); // match 1
        searchExactAdresse("aa dd ee bb","AA BB CC","DD EE",0); // no match
        searchExactAdresse("ff dd bb ff","FF BB CC","DD EE",1); // match 3
    }
    ...
    QueryBuilder getQueryBuilder(String voie)
    {
        ...
        FieldChecker checker0 = new FieldChecker("payloadversustypespanquery");
        GroupedPayloadChecker checker1 = new GroupedPayloadChecker();
        OnePayloadChecker checker2 = new OnePayloadChecker(bytes1.bytes);
