 ...
 * @author Julien
 */
public class PayloadCheckerSpanQuery_MultiPayloadVersusTypeTests extends QueryTests
{
    public PayloadCheckerSpanQuery_MultiPayloadVersusTypeTests()
    {
    ...
    QueryBuilder getQueryBuilder(String voie)
    {
        ...
        AllPayloadChecker checker1 = new AllPayloadChecker(bytes1.bytes);
        AllPayloadChecker checker2 = new AllPayloadChecker(bytes2.bytes);
