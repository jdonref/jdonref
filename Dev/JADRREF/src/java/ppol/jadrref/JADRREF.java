...
/**
 * Service web JADRREF.<br>
 * Cette classe est utilisée pour générer le proxy de l'interface SOAP de JADRREF.<br>
...
public class JADRREF implements IJDONREFv3 {
    ...
    public ResultatGeocodage geocode(
        ...
        if (projectionOption != null && !projectionOption.equals("")) {
            try {
                ...
                Logger.getLogger(JADRREF.class.getName()).log(Level.SEVERE, "La projection n'est pas un nombre.", nfe);
            }
        }
        int distance = 0;
        if (distanceOption != null && !distanceOption.equals("")) {
            try {
                ...
                Logger.getLogger(JADRREF.class.getName()).log(Level.SEVERE, "La distance n'est pas un nombre.", nfe);
            }
        }
